// @flow
import type { ModalsState, ModalName } from './types';
import { Store } from 'redux';
export const modalsStateSelector = (state: Store): ModalsState => state.modals;
export const modalSelector = (name: ModalName, selector: typeof modalsStateSelector = modalsStateSelector) => (state: Store) => {
